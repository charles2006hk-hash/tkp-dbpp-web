                    ...
                    {event.status === 'upcoming' ? (
                      event.registrationUrl ? (
                        <a 
                          ...
                          className="block text-center w-full py-2 bg-slate-800 text-white font-bold rounded-lg hover:bg-slate-900 transition-colors"
                        >
                          前往外部報名
                        </a>
                      ) : (
                        // 🌟 修正點：沒有外部連結時，導向內頁以開啟站內報名 Modal
                        <Link 
